...
Transform inverse(const Transform& t)
{
   ...
   result.scale.x = glm::abs(t.scale.x) < Utility::epsilon ? 0.0f : (1.0f / t.scale.x);
   result.scale.y = glm::abs(t.scale.y) < Utility::epsilon ? 0.0f : (1.0f / t.scale.y);
   result.scale.z = glm::abs(t.scale.z) < Utility::epsilon ? 0.0f : (1.0f / t.scale.z);
